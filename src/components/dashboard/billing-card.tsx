...
import type { BillingCheckoutMethod, BillingProvider, UserAccessState } from "@/types/billing";
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-white/70">{plan.intervalLabel}</p>
                  </div>
                </div>
                <div className="mt-4 flex flex-wrap gap-2">
                  <Button
                    onClick={() => void handleCheckout(plan.key, "antom", "alipay")}
                  ...
                  <Button
                    variant="outline"
                    onClick={() => void handleCheckout(plan.key, "stripe", "card")}

...
const RECENCY_HINT_PATTERN = /\b(latest|current|today|recent|newest)\b|最新|最近|今天/i;
...
export function enrichQueryWithCurrentYear(query) {
...
function normalizeResults(data) {
    var _a;
    return ((_a = data.results) !== null && _a !== void 0 ? _a : []).map((item) => {
        var _a, _b, _c, _d, _e;
        return ({
            title: (_a = item.title) !== null && _a !== void 0 ? _a : "Untitled result",
            url: (_b = item.url) !== null && _b !== void 0 ? _b : "",
            publishedDate: (_d = (_c = item.publishedDate) !== null && _c !== void 0 ? _c : item.published_date) !== null && _d !== void 0 ? _d : "",
            score: typeof item.score === "number" ? item.score : null,
            snippet: (_e = item.text) !== null && _e !== void 0 ? _e : (Array.isArray(item.highlights)
...
function emitToolEvent(onToolEvent, data) {
    onToolEvent === null || onToolEvent === void 0 ? void 0 : onToolEvent({
        type: "tool_event",
        data: Object.assign({ tool: "web_search" }, data),
    });
}
export function createWebSearchTool(context = {}) {
    ...
    return llm.tool({
        ...
        execute: async (params) => {
            ...
            const contentType = (_a = params.contentType) !== null && _a !== void 0 ? _a : DEFAULT_CONTENT_TYPE;
            const maxCharacters = (_b = params.maxCharacters) !== null && _b !== void 0 ? _b : DEFAULT_MAX_CHARACTERS;
            const contents = contentType === "text"
                ? { text: { max_characters: maxCharacters } }
                : { highlights: { max_characters: maxCharacters } };
            const payload = {
                query: executedQuery,
                type: (_c = params.type) !== null && _c !== void 0 ? _c : DEFAULT_SEARCH_TYPE,
                num_results: (_d = params.numResults) !== null && _d !== void 0 ? _d : DEFAULT_NUM_RESULTS,
                contents,
            };
            if (params.livecrawl)
                payload.livecrawl = params.livecrawl;
            ...
            try {
                ...
                return formatResults({
                    ...
                    executedQuery,
                    resolvedSearchType: (_e = data.resolvedSearchType) !== null && _e !== void 0 ? _e : String(payload.type),
                    results,
                });
            }
            catch (error) {

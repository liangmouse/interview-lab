...
export function buildStagePrompt(stage, profile, interview, stageSummaries) {
    const baseInstruction = STAGE_INSTRUCTIONS[stage];
    const candidateContext = `
Name: ${(profile === null || profile === void 0 ? void 0 : profile.nickname) || "Unknown"}
Job: ${(profile === null || profile === void 0 ? void 0 : profile.job_intention) || "Not specified"}
Skills: ${((profile === null || profile === void 0 ? void 0 : profile.skills) || []).join(", ")}
  `.trim();
    const interviewContext = `
Type: ${(interview === null || interview === void 0 ? void 0 : interview.type) || "General"}
Duration: ${(interview === null || interview === void 0 ? void 0 : interview.duration) || 30} mins
  `.trim();
    let memoryContext = "";
...
function buildCandidateContext(profile) {
    if (!profile)
        return "Candidate Profile: Unknown";
    const skills = Array.isArray(profile === null || profile === void 0 ? void 0 : profile.skills)
        ? profile.skills.join(", ")
        : (profile === null || profile === void 0 ? void 0 : profile.skills) || "None";
    return `
